...
import { addPart, clearArrangement, deleteArrangement, editArrangement, loadArragement, saveArrangement, uploadPart } from '../../actions/arrangement';
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        uploadPart: (serialNumber, instrument, file) => dispatch(uploadPart(serialNumber, instrument, file))
    }
}
