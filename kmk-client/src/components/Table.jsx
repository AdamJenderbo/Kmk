...
import { formatDateTime } from '../actions/date';
...
const DateCell = ({colum, row, onEdit, loading}) => {
    ...
    if(edit) {
        ...
        return <td className='last date' style={{width: colum.width}}>{formatDateTime(value)}</td>;
    }
}
...
const SelectCell = ({colum, row, onEdit, loading, disabled}) => {
    ...
    if(edit) {
        ...
        return <td style={{width: colum.width}}>
            <div 
                style={{
                    background: option.color ? option.color : "white",
